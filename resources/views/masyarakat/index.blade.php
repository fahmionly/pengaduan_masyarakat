...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('pengaduan.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-2">
                            <button type="submit" class="btn btn-success">Ajukan Pengaduan</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"> Data Laporan Saya</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('pengaduan.destroy', $row->id)}}" method="post">
                                                @csrf
                                                {{method_field('DELETE')}}
                                                <a href="{{route('pengaduan.show',$row->id)}}" class="btn btn-info">
                                                    Detail
                                                </a>
